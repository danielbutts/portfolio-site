  ...
  .then(function () {
    return knex('projects').insert([
      { id: 1,
        ...
        image_url: 'https://github.com/danielbutts/pantry-manager/blob/master/screenshots/pantry-manager-screenshot.png',
      ...
      { id: 2,
        ...
        image_url: 'https://github.com/danielbutts/job-tracker/blob/master/screenshot.png',
